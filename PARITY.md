...
>
> **สรุปตัวเลข: 38 / 86 ≈ 44% ของฟีเจอร์เว็บ** — อัปเดต 2026-07-30 คืน (+C5 ปลาหนี, +A5 ปุ่มเรด้า, +E1 ป้าย ♻️, +E8 ประตูวาป)
...
| K6 | tutorial / tip cards | ⚠️ มี hint line ในทัวร์ · tutorial เต็มยังไม่มี (D10) · หมายเหตุ: `#hint` ของเว็บเป็นของโหมด **แก้ไข** ไม่ใช่โหมดดู (`body.view #hint{display:none}` :184) → ไม่ต้องทำในหน้าดูแมพ |
