...
>
> **สรุปตัวเลข: 45 / 86 ≈ 52% ของฟีเจอร์เว็บ** — อัปเดต 2026-07-31 เช้า (**A4 หน้ารายการแมพ 0.5 → 1.0**: พอร์ตใหม่ทั้งหน้าจาก RN `map.tsx` · เหลือ ☁ ออฟไลน์ + "by You" ที่ผูกกับ J)
> ก่อนหน้า: 44.5 (2026-07-30 คืน · +C5 ปลาหนี, +A5 ปุ่มเรด้า, +E1 ป้าย ♻️, +E8 ประตูวาป, +E5 ร้านค้า, +D10 สอนเล่น, +D9 จุดเกิดสุ่ม, +E4 wallet ออนไลน์, +G หมุด 3 ข้อ, +A7 ตัวเลขเฟรมเรต)
...
## E. เกม (เก็บขยะ / เหรียญ / ร้านค้า) — 6.5/8 (P3a + P3b + E8 · E5 ครึ่งเดียว)
| # | ฟีเจอร์ | หลักฐาน |
|---|---|---|
