...
>
> **สรุปตัวเลข: 44.5 / 86 ≈ 52% ของฟีเจอร์เว็บ** (ลดลงจาก 46 หลัง user ทักว่า A4/E5 เคลมเกินจริง) — อัปเดต 2026-07-30 คืน (+C5 ปลาหนี, +A5 ปุ่มเรด้า, +E1 ป้าย ♻️, +E8 ประตูวาป, +E5 ร้านค้า, +D10 สอนเล่น, +D9 จุดเกิดสุ่ม, +E4 wallet ออนไลน์, +G หมุด 3 ข้อ, +A7 ตัวเลขเฟรมเรต)
...
| A4 | รายการแมพ + ค้นหา + thumbnail | `_objList` / API public | ⚠️ **มีแค่ครึ่งเดียว** (user ทักด้วยภาพ 31 ก.ค.): ขาด **แบนเนอร์ Play Game!** · ปุ่ม **+ สร้างแมพ** · ปุ่ม **บัญชี** · การ์ด 2 คอลัมน์รูปใหญ่ · ♡ ถูกใจ · ☁ เก็บออฟไลน์ · ⋯ เมนู · `by ชื่อคนสร้าง` (API ส่ง `ownerName` มาแล้วแต่ไม่ได้ใช้) · ไอคอนแว่นในช่องค้นหา |
