...
>
> **สรุปตัวเลข: 36 / 86 ≈ 42% ของฟีเจอร์เว็บ** — อัปเดต 2026-07-30 (+toast, +ทัวร์ D1/D2/D4/D8)
...
| A5 | มินิแมพ + เรด้าแสดงสัตว์/วัตถุรอบตัว | `drawMinimap()` :3714, `radarBtn` | ✅ มินิแมพในทัวร์ (ปุ่มเปิด/ปิดเรด้ายังไม่มี) |
...
## E. เกม (เก็บขยะ / เหรียญ / ร้านค้า) — 3.5/8 (P3a)
| # | ฟีเจอร์ | หลักฐาน |
|---|---|---|
| E1 | ขยะเกิดในแมพ (หลายชนิด + sprite) | `spawnTrash()`, `_buildTrash()`, `_trashSprite()` | ✅ P3a (5 ชนิดตามน้ำหนักเว็บ · ยังไม่มีป้าย ♻️ ลอย) |
...
| K6 | tutorial / tip cards | ⚠️ มี hint line ในทัวร์ · tutorial เต็มยังไม่มี |
