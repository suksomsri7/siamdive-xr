...
>
> **สรุปตัวเลข: 46 / 86 ≈ 53% ของฟีเจอร์เว็บ** — อัปเดต 2026-07-30 คืน (+C5 ปลาหนี, +A5 ปุ่มเรด้า, +E1 ป้าย ♻️, +E8 ประตูวาป, +E5 ร้านค้า, +D10 สอนเล่น, +D9 จุดเกิดสุ่ม, +E4 wallet ออนไลน์, +G หมุด 3 ข้อ, +A7 ตัวเลขเฟรมเรต)
...
## D. ทัวร์ดำน้ำ (โดรน) — 8/10 (P1.1 + P1.2 + D9 + D10)
...
## E. เกม (เก็บขยะ / เหรียญ / ร้านค้า) — 7/8 (P3a + P3b + E5 + E8)
| # | ฟีเจอร์ | หลักฐาน |
|---|---|---|
