...
namespace DiveMap.Core
{
    ...
    public static class FleeMath
    {
        ...
        /// </summary>
        /// ⬇️ ประวัติการจูน (user ตัดสินจากเครื่องจริง — ห้ามดันกลับขึ้นโดยไม่ถาม):
        ///    สูตรเว็บ (R=12 → เตือน +7.7 ม.) → 2.0 ช่วงตัว (+3.8) → **0.5 ช่วงตัว (+0.95)**
        ///    "ลดระยะอีก ยังมากไป" (21 ส.ค.) ⇒ แทบทุกความเร็วต้องเข้าไปถึงตัวถึงจะมีอะไรเกิดขึ้น
        ///    ค่าต่ำสุดที่มีความหมายคือ 0 = ตกใจตอนชนอย่างเดียวทุกความเร็ว (แรงยังต่างกันตามสปีด)
        public const double StartleWarnBodyLengths = 0.5;
