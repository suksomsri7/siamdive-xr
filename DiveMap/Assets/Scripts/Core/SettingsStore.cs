...
namespace DiveMap.Core
{
    ...
    public static class SettingsStore
    {
        ...
        // 🔴 16 ส.ค. 2026 — สัญญาเดิม "พรีเซ็ต 'ช้า' = โดรนของ build 261 (9 u/s) เป๊ะ" **หมดอายุ
        // แล้วโดยธรรมชาติ**: user ขอลดความเร็วฐานสี่รอบจนเหลือ 12 u/s ซึ่งห่างจาก 9 แค่ 25%
        // ⇒ ถ้ายังตรึงไว้ที่ 9 พรีเซ็ต "ช้า" จะแทบไม่ต่างจาก "ปกติ" และการตั้งค่าก็ไม่มีความหมาย
        // ตอนนี้จึงตรึงสิ่งที่ยังเป็นความจริงแทน: "ช้า" ต้องช้ากว่าปกติอย่างรู้สึกได้ แต่ไม่ช้าจน
        // ข้ามไซต์ไม่ไหว · 12 × 0.6 = 7.2 u/s = 1.20 m/s
        // ⚠️ ยังเป็นค่าที่ผูกกับ DroneFlight.Speed — เปลี่ยนความเร็วฐานเมื่อไร ต้องดูตัวนี้ทุกครั้ง
