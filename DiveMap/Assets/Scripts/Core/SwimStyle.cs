...
namespace DiveMap.Core
{
    ...
    public static class SwimStyle
    {
        ...
        /// </summary>
        /// <summary>
        /// 🔴 9 ส.ค. (รอบสุดท้าย) — ทุกการเลือกความเร็วก่อนหน้านี้ตัดสินบนสัญญาณที่เสีย
        ///
        /// ตลอดสองวัน user รายงาน "หางเร็วเกินไป" แล้วเราก็กดค่านี้ลงเรื่อยๆ: 1.0 → 0.25 (8 ส.ค.
        /// ผ่าน GIF) → 0.040 ("ช่อง 4" 9 ส.ค.) · แต่สิ่งที่ user เห็นว่าเร็วไม่ใช่จังหวะหางเลย —
        /// เป็นเฟสประจำตัวที่ถูกแฮชเขย่าทุกเฟรม (ดู DM_FishWave.cginc / DM_InstancePhase) ซึ่ง
        /// ไม่ขึ้นกับค่านี้แม้แต่นิดเดียว · พอแก้ตัวนั้นเสร็จ (build 365) ค่าที่เหลือจึงโผล่มาตาม
        /// จริง และ user รายงานทันทีว่า "ทุกตัวไม่ขยับหางเลย แข็งมาก" — 0.032 Hz คือหนึ่งครั้ง
        /// ต่อ 31 วินาที
        ///
        /// ⇒ ค่าที่เลือกไว้ทั้งหมดเป็นโมฆะ เพราะตัดสินจากภาพที่มีสัญญาณรบกวนปนอยู่ · ตั้งใหม่ที่
