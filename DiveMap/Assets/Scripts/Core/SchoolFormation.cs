...
namespace DiveMap.Core
{
    ...
    public static class SchoolFormation
    {
        ...
        /// </summary>
        /// ตัวเลขที่ใช้ตัดสิน (`tools/school_sim/pod_stretch.py` — วัดแกนหลักของกลุ่มสลอต):
        ///
        ///     ทรง        แนวตั้ง 0..1   เป็นแถว σ1/σ2
        ///     cluster        0.05           1.26      ✅ อยู่ในถุง
        ///     vortex         0.01           1.00      ✅
        ///     ball           —              1.10      ✅
        ///     stream         0.00           5.61      ✅ เป็นแถวก็จริง แต่**แนวนอน** ไม่ใช่อาการ
        ///     cone           0.83           1.24      ❌ ตัดออก
        ///     tornado        0.99           2.52      ❌ ตัดออก — เสาตั้งฉากกับพื้นชัดที่สุด
        ///
        /// user ยืนยันเอง 22 ส.ค. ว่าอาการคือ **"เสาตั้งฉากกับพื้น"** ⇒ เกณฑ์คัดคือคอลัมน์
        /// "แนวตั้ง" ไม่ใช่ "เป็นแถว" · stream จึงอยู่ต่อได้ (ฝูงเดินทางเป็นแนวนอนคือของธรรมชาติ
        /// ของปลากะมง) ส่วน tornado/cone ออกเพราะสลอตวางด้วย <c>Y = CylY × R×1.8</c> = เสาแท้ ๆ
        public static readonly SchoolMode[] PodModes =
        {
            SchoolMode.Cluster, SchoolMode.Cluster, SchoolMode.Cluster,
            SchoolMode.Cluster, SchoolMode.Stream,  SchoolMode.Vortex, SchoolMode.Ball,
        };
