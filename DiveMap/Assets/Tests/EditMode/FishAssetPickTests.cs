...
namespace DiveMap.Tests
{
    ...
    public class FishAssetPickTests
    {
        ...
        [Test]
        public void Yellowtail_BigSchool_TakesLod1()
        {
            // 100 × 8,800 tris of LOD0 would be 880k on its own → LOD1 (3,999).
            Assert.IsTrue(FishAssetPick.TryPick("pod:yellowtail", Trev0, Trev1, 100, out FishAssetPick.Pick p));
        ...
        [Test]
        public void Yellowtail_SmallPod_StaysOnLod0()
        {
        ...
        public void MissingLod0_FallsBackToLod1_AndViceVersa()
        {
            ...
            // Big school, heavy LOD0, but no LOD1 shipped → LOD0 rather than no fish at all.
            Assert.IsTrue(FishAssetPick.TryPick("pod:yellowtail", Trev0, null, 100, out FishAssetPick.Pick b));
